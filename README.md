...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create tanda-protocol-c98a
  fly apps create tanda-protocol-c98a-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app tanda-protocol-c98a
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app tanda-protocol-c98a-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'tanda-protocol-c98a-staging' does not match app name in config file 'tanda-protocol-c98a'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name tanda-protocol-c98a-db
  fly postgres attach --app tanda-protocol-c98a tanda-protocol-c98a-db

  fly postgres create --name tanda-protocol-c98a-staging-db
  fly postgres attach --app tanda-protocol-c98a-staging tanda-protocol-c98a-staging-db
  ```
